...
public class ProgressParser {
    ...
    public static OffsetDateTime parseDateTimeString(String str) {
        return ZonedDateTime.from(ProgressParser.DATE_TIME_FORMATTER.parse(str)).toOffsetDateTime();
    }
    ...
    public static OffsetTime parseTimeString(String str) {
        return ZonedDateTime.from(ProgressParser.TIME_FORMATTER.parse(str)).toOffsetDateTime().toOffsetTime();
    }
    ...
    private static void instantiateMapper() {
        ...
        module.addDeserializer(OffsetDateTime.class, new JsonDeserializer<>() {
            ...
            public OffsetDateTime deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
                ...
                return ProgressParser.parseDateTimeString(value);
            }
        });
